...
function M:onInit()
    ...
    Widget.setWidth(ui, Widget.SIZING_GROW, 0, 0)
    Widget.setHeight(ui, Widget.SIZING_GROW, 0, 0)
    ...
    -- Widget.setWidth(version, Widget.SIZING_FIT, 0, 0)
    -- Widget.setHeight(version, Widget.SIZING_FIT, 0, 0)
